...
export declare const useMoralisWeb3Api: () => {
    ...
    native: {
        ...
        runContractFunction: (options: {
            ...
            address: string;
        }) => Promise<string & import("moralis/types/generated/web3Api").defaultResponse<string>>;
    };
    account: {
    ...
    token: {
        ...
        syncNFTContract: (options: {
            ...
            address: string;
        }) => Promise<import("moralis/types/generated/web3Api").defaultResponse<unknown>>;
    ...
    info: {
        web3ApiVersion: () => Promise<{
            version: string;
        } & import("moralis/types/generated/web3Api").defaultResponse<{
            version: string;
        }>>;
        endpointWeights: () => Promise<{
            endpoint: string;
            path: string;
