/*Since 08/08/2022 Moralis upgraded to Ver 2. The dependency of this project is Ver 1, Version 2 was installed by accident. // To remove morali npm remove moralis 
// To install moralis-v1 npm install moralis-v1 // From const Moralis = require("moralis/node"); // To const Moralis = require("moralis-v1/node");*/ 

const Moralis = require("moralis-v1/node");
const fs = require("fs");

const serverUrl ="https://HARDENED/server";

const appId="z5NHARDENEDKzWfRpQctH";

const contractAddress = "0xHARDENED8b"; //Moonbirds
